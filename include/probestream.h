...
typedef void (*probestream_read_probe_cb_t)(void *obj, const void *buf,
    size_t buf_size, ssize_t return_value);
 ...
 * The callbacks are both issued after the relative operation has been performed.
*/
probestream_t *open_probestream(async_t *async, void *obj,
    bytestream_1 source, probestream_close_probe_cb_t close_cb,
